      ...
      <div className="hidden lg:flex lg:w-1/2 bg-brand-900 relative overflow-hidden">
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          <Link href="/" className="w-fit">
            <img src="/logo-clean-white.png?v=2" alt="Publi Legal" className="h-10 w-auto hover:opacity-90 transition-opacity" />
          </Link>
          <div>
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
          <div className="w-full max-w-md">
            <div className="lg:hidden mb-8">
              <img src="/logo-clean.png?v=2" alt="Publi Legal" className="h-8 w-auto" />
            </div>
